...
def build():
    ...
    add_body(doc, "Pakistan's school year is increasingly disrupted by climate shocks — heatwaves crossing 45 °C, monsoon flooding, and seasonal air pollution. Across our 50-school pilot in Gujranwala, average attendance fell from 93.0% in 2023 to 88.4% in 2025 — a 4.6 percentage-point decline that maps closely onto extreme-weather windows. School operators today have no per-school visibility into hazard exposure: provincial forecasts arrive too late to plan around, public health advisories are not school-aware, and parents are not notified when their child's school is at risk. As a result decisions are reactive (closing schools after the heat has already hit) rather than pre-emptive. The 50 schools in our pilot serve roughly 31,000 children — a population for whom every lost school-day compounds existing learning gaps from COVID, inflation, and chronic under-investment in education infrastructure.")
    ...
    add_body(doc, "Independently, three years of historical attendance data from Premier DLC (2023–2025, monthly, all 50 schools) shows average attendance falling from 93.0% to 88.4% — a 4.6 percentage-point decline that aligns with rising heat and climate stress. The combined hazard + outcome data gives the platform an empirical foundation that purely modeled risk scores lack.")
    placeholder(doc, "Zeeshan's version:")
