...
├── scores.json            Per-school hazard scores + forecasts — snapshot fallback; the live
│                          copy is refreshed daily to the `data` branch by
│                          .github/workflows/refresh-data.yml and read first by site + Worker
